...
public abstract class Hilt_SavedImageFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SavedImageFragment() {
    super();
  }

  Hilt_SavedImageFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SavedImageFragment_GeneratedInjector) this.generatedComponent()).injectSavedImageFragment(UnsafeCasts.<SavedImageFragment>unsafeCast(this));
    }
  }
